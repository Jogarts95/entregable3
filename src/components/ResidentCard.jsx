...
export const ResidentCard = ({ residentUrl }) => {
	...
	return (
		<article className="residentCard residentCard__glow">
			...
			<section className="residentCard__info">
				...
				<ul className="residentCard__list">
					<li className="residentCard__item">
						<span>Specie: </span>{residentInfo?.species}</li>
					<li className="residentCard__item">
						<span>Origin: </span>{residentInfo?.origin.name}</li>
					<li className="residentCard__item">
						<span>Episodes where appear: </span>{residentInfo?.episode.length}</li>
				</ul>
			</section>
		</article>
	);
